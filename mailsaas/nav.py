...
NAV = [
    ...
    },
    {
        ...
        # One consolidated, list-first page — lists, tags, import/export,
        # suppression and settings are all managed in place.
        "items": [
...
#  renders with no header (standalone links).
# --------------------------------------------------------------------------- #
...
ESSENTIAL = {
    # admin essentials
    "admin", "smtp", "pools", "queue", "warmup", "iphealth",
