...
NAV = [
    ...
    {"key": "segments", "label": "Segments", "icon": "🎯", "built": True,
     "items": [("Rule builder", "Status, tags, engagement, custom fields"),
               ("Live count", "See the audience size instantly"),
               ("Use in campaigns", "Target a segment when sending")]},
    {"key": "suppression", "label": "Suppression List", "icon": "🚫", "built": True,
     "items": [("Global never-send", "Emails & whole domains"),
               ("Bulk import", "Paste or upload addresses"),
               ("List hygiene automation", "Auto-clean before every send")]},
...
USER_GROUPS = [
    ("", ["dashboard"]),
    ("📧 Email", ["contacts", "segments", "suppression", "campaigns", "templates",
                 "verification", "burstcamp", "sender"]),
    ("🤖 AI", ["ai"]),
